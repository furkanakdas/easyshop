...
export const config = {
  ...
  REVIEW_POSTGRES_HOST:getEnvVar("REVIEW_POSTGRES_HOST"),
  REVIEW_POSTGRES_PORT:getEnvVar("REVIEW_POSTGRES_PORT"),
  REVIEW_POSTGRES_USERNAME:getEnvVar("REVIEW_POSTGRES_USERNAME"),
  REVIEW_POSTGRES_PASSWORD:getEnvVar("REVIEW_POSTGRES_PASSWORD"),
  REVIEW_POSTGRES_NAME:getEnvVar("REVIEW_POSTGRES_NAME"),
