...
export const config = {
  ...
  STRIPE_TEST_SECRET_KEY:getEnvVar("STRIPE_TEST_SECRET_KEY"),
  STRIPE_TEST_PUBLISHABLE_KEY:getEnvVar("STRIPE_TEST_PUBLISHABLE_KEY"),
  ...
  PRODUCT_POSTGRES_HOST: getEnvVar('PRODUCT_POSTGRES_HOST'),
  PRODUCT_POSTGRES_PORT: getEnvVar('PRODUCT_POSTGRES_PORT'),
  PRODUCT_POSTGRES_USERNAME: getEnvVar('PRODUCT_POSTGRES_USERNAME'),
  PRODUCT_POSTGRES_PASSWORD: getEnvVar('PRODUCT_POSTGRES_PASSWORD'),
  PRODUCT_POSTGRES_NAME: getEnvVar('PRODUCT_POSTGRES_NAME'),
