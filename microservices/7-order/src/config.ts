...
export const config = {
  ...
  ORDER_POSTGRES_HOST: getEnvVar("ORDER_POSTGRES_HOST"),
  ORDER_POSTGRES_PORT: getEnvVar("ORDER_POSTGRES_PORT"),
  ORDER_POSTGRES_USERNAME: getEnvVar("ORDER_POSTGRES_USERNAME"),
  ORDER_POSTGRES_PASSWORD: getEnvVar("ORDER_POSTGRES_PASSWORD"),
  ORDER_POSTGRES_NAME: getEnvVar("ORDER_POSTGRES_NAME"),
